...
## 2.0.0 - 2026-01-29
- **ES 8.x Support**: Upgraded to support Elasticsearch 8.x
- Removed document type from all ES URLs (types deprecated in ES 7.x, removed in ES 8.x)
- Changed bulk URL format from `/{index}/{type}/_bulk` to `/{index}/_bulk`
- Changed search URL format from `/{index}/{type}/_search` to `/{index}/_search`
- Changed single doc URL format to `/{index}/_doc`
- Updated context path to `/egov-indexer-v2`
