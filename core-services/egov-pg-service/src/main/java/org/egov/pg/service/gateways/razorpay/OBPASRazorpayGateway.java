...
@Component
@Slf4j
public class OBPASRazorpayGateway implements Gateway{
	private static final String GATEWAY_NAME = "OBPASRAZORPAY";
    ...
    @Autowired
    public OBPASRazorpayGateway(ObjectMapper objectMapper, Environment environment) {
