...
public class WorkflowConfig {
	...
	@Value("${persister.ao.transition.wf.topic}")
	private String assigneMoveOnlyTopic;

	
	@Value("${persister.mo.transition.wf.topic}")
	private String moveOnlyTopic;
	
	@Value("${persister.imo.transition.wf.topic}")
	private String internalMovementTopic;
