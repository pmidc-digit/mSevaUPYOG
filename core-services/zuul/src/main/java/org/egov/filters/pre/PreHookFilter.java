...
public class PreHookFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        try {
            ...
            ExceptionUtils.raiseCustomException(org.springframework.http.HttpStatus.valueOf(e.getStatusCode().value()), "PRE_HOOK_ERROR - Pre-hook url threw an error - " + e.getMessage());
        } catch (Exception e) {
