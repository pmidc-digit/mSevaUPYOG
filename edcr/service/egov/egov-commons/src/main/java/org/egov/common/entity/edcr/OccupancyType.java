...
public enum OccupancyType {
	...
	OCCUPANCY_F("Mercantile / Commercial"), OCCUPANCY_F1("Commercial Parking Plaza"), OCCUPANCY_F2("Commercial Parking Appurtenant"), OCCUPANCY_F3("Hotels"), OCCUPANCY_F4("Kiosk"),
