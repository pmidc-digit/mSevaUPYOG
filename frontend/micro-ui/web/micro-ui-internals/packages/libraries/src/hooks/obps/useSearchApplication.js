...
export const useLayoutCitizenSearchApplication = (params, tenantId, applicationNo, config = {}, t) => {
  ...
  const result = useQuery(["LAYOUT_APPLICATIONS_LIST", params, applicationNo], useLayoutSearch(params, tenantId, applicationNo, config), {
...
export const useLayoutCheckListSearch = (params, tenantId, config = {}) => {
  ...
  const result = useQuery(["LAYOUT_CHECKLIST_SEARCH", params], useLayoutCheckListSearchFn(params, tenantId), {
    staleTime: Infinity,
    ...config,
  });
