...
const fetchComplaintDetails = async (tenantId, id) => {
  var serviceDefs = await Digit.MDMSService.getSwachBharatCategory(tenantId, "Swach");
...
const useSwachComplaintDetails = ({ tenantId, id }) => {
...
export default useSwachComplaintDetails;
