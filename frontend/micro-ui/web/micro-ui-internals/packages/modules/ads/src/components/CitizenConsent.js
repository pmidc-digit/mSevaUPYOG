...
const CitizenConsent = ({ showTermsPopupOwner, setShowTermsPopupOwner, otpVerifiedTimestamp, getModalData, getUser, getShowOtp }) => {
  ...
  const selfdeclarationform = `
    <div class="ads-consent-declaration">

      <h1 class="ads-consent-declaration__title">
        SELF-DECLARATION FOR ADVERTISEMENT / HOARDING PERMISSION
      </h1>

      <div class="ads-consent-declaration__intro">
        <p class="ads-consent-declaration__paragraph">
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">1.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">2.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">3.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">4.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">5.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">6.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">7.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">8.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">9.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">10.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">11.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">12.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">13.</span>
      ...
      <div class="ads-consent-declaration__item">
        <span class="ads-consent-declaration__item-number">14.</span>
  ...
  return (
    <div>
      <Modal
        ...
        className="ads-citizen-consent__modal-content"
        overlayClassName="ads-citizen-consent__modal-overlay"
      >
        <div>
          <div
          ...
          {isUploading || setOtpLoading ? (
            ...
            <div>
              <div className="ads-components-citizen-consent--style-1">
                <SubmitBar label={t("BPA_CLOSE")} onSubmit={closeModal} />
              </div>
              <br></br>
              {!isCitizenDeclared && !isOTPVerified && !getShowOtp && (
                <div className="ads-components-citizen-consent--style-2">
                  <br></br>
              ...
              {showOTPInput && !isCitizenDeclared && !isOTPVerified && (
                <React.Fragment>
                  ...
                  {otpError && <CardLabel className="ads-components-citizen-consent--style-3">{t(otpError)}</CardLabel>}
                  {otpSuccess && <CardLabel className="ads-components-citizen-consent--style-4">{t(otpSuccess)}</CardLabel>}
                </React.Fragment>
              )}
              ...
              {isOTPVerified && !isCitizenDeclared && (
                <div className="ads-components-citizen-consent--style-5">
                  <br></br>
