    ...
    <React.Fragment>
      <div className="filter">
        <div className="filter-card">
          <div className="heading ads-components-inbox-new-inbox-filter--style-1" >
            <div className="filter-label ads-components-inbox-new-inbox-filter--style-2" >
              <span>
              ...
              <span className="ads-components-inbox-new-inbox-filter--style-3">{t("ES_COMMON_FILTER_BY")}:</span>
            </div>
            <div className="clearAll" onClick={clearAll}>
              {t("ES_COMMON_CLEAR_ALL")}
            </div>
            {props.type === "desktop" && (
              <span className="clear-search ads-components-inbox-new-inbox-filter--style-4" onClick={clearAll} >
