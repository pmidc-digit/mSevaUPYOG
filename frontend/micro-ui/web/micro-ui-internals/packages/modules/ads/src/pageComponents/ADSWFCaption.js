...
import ADSWFReason from "./ADSWFReason";

const ADSWFCaption = ({ data, OpenImage }) => {
  ...
  return (
    <div>
      ...
      {data.comment && <ADSWFReason otherComment={data?.otherComment} headComment={data?.comment}></ADSWFReason>}
      {data?.wfComment ? (
        <div>
