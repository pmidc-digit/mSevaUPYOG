...
const OwnerForm = (_props) => {
    ...
    const { data: maintainenceTypeMDMS } = Digit.Hooks.useCustomMDMS(Digit.ULBService.getStateId(), "ASSET", [{ name: "AssetMaintenanceType" }], {
        select: (data) => {
    ...
    const { data: paymentTypeOptMDMS } = Digit.Hooks.useCustomMDMS(Digit.ULBService.getStateId(), "ASSET", [{ name: "AssetPaymentType" }], {
        select: (data) => {
    ...
    const { data: maintenanceCycleOptMDMS } = Digit.Hooks.useCustomMDMS(Digit.ULBService.getStateId(), "ASSET", [{ name: "AssetMaintenanceCycle" }], {
        select: (data) => {
