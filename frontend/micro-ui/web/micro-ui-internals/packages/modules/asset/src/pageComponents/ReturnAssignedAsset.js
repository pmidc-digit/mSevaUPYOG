import { CardLabel, CardLabelError, LabelFieldPair, TextInput, Toast, Row, StatusTable } from "@mseva/digit-ui-react-components";
...
const OwnerForm = (_props) => {
  const { returndetails, focusIndex, allAssets, setreturndetails, t, config, setError, clearErrors, formState, setFocusIndex } = _props;
    ...
    <React.Fragment>
      <div style={{ marginBottom: "16px" }}>
        <div style={{ border: "1px solid #E3E3E3", padding: "16px", marginTop: "8px" }}>
          {allAssets?.length > 2 ? <div style={{ marginBottom: "16px", padding: "5px", cursor: "pointer", textAlign: "right" }}>X</div> : null}
