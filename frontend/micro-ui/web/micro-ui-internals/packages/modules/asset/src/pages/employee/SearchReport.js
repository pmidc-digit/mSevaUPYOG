...
import ASSETReportApplication from "../../components/SearchReportApplication";



const SearchReport = ({path}) => {
    ...
    return <React.Fragment>
        <ASSETReportApplication t={t} isLoading={isLoading} tenantId={tenantId} setShowToast={setShowToast} onSubmit={onSubmit} data={  isSuccess && !isLoading ? (searchReult.length>0? searchReult : { display: "ES_COMMON_NO_DATA" } ):""} count={count} /> 
        {showToast && (
        <Toast
