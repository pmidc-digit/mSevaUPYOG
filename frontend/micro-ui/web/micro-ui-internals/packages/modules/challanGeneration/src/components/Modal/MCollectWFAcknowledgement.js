import { Banner, Card, CardText, LinkButton, ActionBar, SubmitBar } from "@mseva/digit-ui-react-components";
...
const MCollectWFAcknowledgement = () => {
  ...
  return (
    <Card>
      ...
      <ActionBar className="challan-generation-style-669a0ee4e0">
