...
import { CardLabel, LabelFieldPair, Dropdown, TextInput, LinkButton, CardLabelError, MobileNumber, DatePicker, Loader, CardSectionHeader } from "@mseva/digit-ui-react-components";
    ...
    <React.Fragment>
      <div>
        ...
        <LabelFieldPair>
          ...
          <CardLabelError className="challan-generation-form-field-error">{localFormState.touched.ConsumerName ? errors?.ConsumerName?.message : ""}</CardLabelError>
          <LabelFieldPair>
            <CardLabel className="card-label-smaller challan-generation-style-f9f0ebc1c8">{`${t("UC_MOBILE_NUMBER")}`}</CardLabel>
            <div className="field">
              <Controller
                control={control}
                name={"mobileNumber"}
