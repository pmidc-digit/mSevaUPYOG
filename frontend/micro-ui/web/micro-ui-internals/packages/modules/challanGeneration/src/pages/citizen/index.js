...
const App = () => {
  ...
  return (
    <span className={"chb-citizen challan-generation-style-6fbc35255f"}>
      <Switch>
        <AppContainer>
          {!isResponse ?
          <div className={window.location.href.includes("application-overview") || isMobile ? "challan-generation-citizen-breadcrumb--offset" : ""}>
