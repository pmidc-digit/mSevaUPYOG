...
const CHBInboxSearch = ({ values, onSearch }) => {
  ...
  return (
    <form
      className="new-inbox-topbar chb-new-inbox-search"
      onSubmit={(event) => {
        event.preventDefault();
        onSearch(searchValues);
      }}
    >
      <div className="chb-new-inbox-search-fields">
        <label>
      ...
      <div className="chb-new-inbox-search-actions">
        <button type="submit" className="chb-new-inbox-search-button">
          {t("ES_COMMON_SEARCH")}
        </button>
        <button type="button" className="chb-new-inbox-clear-button" onClick={clearSearch}>
