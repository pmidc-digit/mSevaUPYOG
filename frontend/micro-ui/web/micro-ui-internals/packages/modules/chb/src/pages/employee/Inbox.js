...
import CHBInboxFilters from "./CHBInboxFilters";
import CHBInboxSearch from "./CHBInboxSearch";
...
const Inbox = ({ parentRoute }) => {
  ...
  function formReducer(state, payload) {
    ...
    Digit.SessionStorage.set("CHB.INBOX", nextState);
    return nextState;
  }

  const storedInboxState = Digit.SessionStorage.get("CHB.INBOX");
  ...
  return (
    <InboxWrapper
      ...
      topBar={<CHBInboxSearch values={formState.searchForm} onSearch={handleSearch} />}
      pagination={
        <InboxPagination
