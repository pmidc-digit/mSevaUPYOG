...
export const useNEFTDetails = (props, t) => {
  const config = [
    {
      head: t("PAYMENT_NEFT_HEAD"),
      headId: "paymentInfo",
      body: [
        {
          withoutLabel: true,
          ...
          populators: {
            ...
            component: (props, customProps) => <NEFTDetailsComponent onChange={props.onChange} chequeDetails={props.value} {...customProps} />,
          },
        },
      ],
    },
  ...
  return { neftConfig: config };
};

// to be used in config

export const NEFTDetailsComponent = (props) => {
  ...
  return (
    <React.Fragment>
      <div className="label-field-pair">
        <h2 className="card-label">{t("PAYMENT_NEFT_NO_LABEL")} *</h2>
        <div className="field">
      ...
      <div className="label-field-pair">
        <h2 className="card-label">{t("PAYMENT_NEFT_DATE_LABEL")} *</h2>
        <div className="field">
          <div className="field-container">
            <DatePicker
              isRequired={true}
