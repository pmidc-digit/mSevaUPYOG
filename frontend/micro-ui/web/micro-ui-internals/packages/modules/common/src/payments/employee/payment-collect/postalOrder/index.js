...
export const usePostalDetails = (props, t) => {
  const config = [
    {
      head: t("PAYMENT_POSTAL_ORDER_HEAD"),
      headId: "paymentInfo",
      body: [
        {
          withoutLabel: true,
          ...
          populators: {
            ...
            component: (props, customProps) => <PostalDetailsComponent onChange={props.onChange} chequeDetails={props.value} {...customProps} />,
          },
        },
      ],
    },
  ...
  return { postalOrderConfig: config };
};

// to be used in config

export const PostalDetailsComponent = (props) => {
