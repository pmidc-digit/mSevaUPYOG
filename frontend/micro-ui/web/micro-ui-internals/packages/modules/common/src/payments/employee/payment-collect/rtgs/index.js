      ...
      body: [
        {
          ...
          populators: {
            ...
            component: (props, customProps) => <RTGSDetailsComponent onChange={props.onChange} chequeDetails={props.value} {...customProps} />,
          },
        },
      ],
    },
  ...
  return (
    <React.Fragment>
      <div className="label-field-pair">
        <h2 className="card-label">{t("PAYMENT_RTGS_NO_LABEL")} *</h2>
        <div className="field">
      ...
      <div className="label-field-pair">
        <h2 className="card-label">{t("PAYMENT_RTGS_DATE_LABEL")} *</h2>
        <div className="field">
          <div className="field-container">
            <DatePicker
              isRequired={true}
