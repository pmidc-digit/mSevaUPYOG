import { Dropdown, FormComposer, InfoBannerIcon, Loader, Localities, RadioButtons, Toast } from "@mseva/digit-ui-react-components";
          ...
          <Link
            to={
              window.location.href.includes("/ws/")
                ...
                ? "/digit-ui/citizen/obps/bpa/building_plan_scrutiny/new_construction/create-property"
