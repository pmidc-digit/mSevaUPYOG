    ...
    {/* .  <div className="footerCont">
      <div className="footer">
        <div className="footerText">
          ...
          <span  className="upyog-copyright-footer" style={{ cursor: "pointer", border:'2px solid yellow',fontSize: window.Digit.Utils.browser.isMobile()?"12px":"12px", fontWeight: "400"}} onClick={() => { window.open('https://niua.in/', '_blank').focus();}} >Copyright © 2025 -</span>
