import { AppContainer, Card, CardCaption, Header, Loader, PrevIcon } from "@mseva/digit-ui-react-components";
...
const DocumentCategories = ({ t, parentRoute }) => {
  ...
  if (!Digit.UserService?.getUser()?.access_token) {
    return <Redirect to={{ pathname: `/digit-ui/citizen/select-language`, state: { from: location.pathname + location.search } }} />;
  }
