...
import useQuestionsInboxTableConfig from './Inbox/Questions/useQuestionsInboxTableConfig'
import SearchQuestionsFieldsComponents from './Inbox/Questions/SearchQuestionsFieldsComponents'
...
const SearchQuestions = ({parentRoute}) => {
  ...
  const SearchFormFields = useCallback(({ registerRef, searchFormState, controlSearchForm }) => <SearchQuestionsFieldsComponents {...{ registerRef, searchFormState, controlSearchForm }} />, [])
  ...
  const Categories=[        {
    ...
    "question":"What is your feedback on this product?",
    "isActive": false,
    "tenantId": "pb.testing",
    "auditDetails": {
...
const handleDelete =()=>{
  ...
  const propsForInboxTable = useQuestionsInboxTableConfig({  ...{ parentRoute, onPageSizeChange, formState, totalCount: TotalCount, table: Categories, noResultsMessage: "No Questions found", dispatch, inboxStyles:{overflowX:"scroll", overflowY:"hidden"},setShowToast} })
