...
import { FilterFormField, Loader, Dropdown } from "@mseva/digit-ui-react-components";
          ...
          render={({ ref, onChange, value }) => {
            return (
              <>
                ...
                <Dropdown inputRef={ref} option={statuses} optionKey="code" t={t} select={onChange} selected={value} />
              </>
            );
          }}
        />
