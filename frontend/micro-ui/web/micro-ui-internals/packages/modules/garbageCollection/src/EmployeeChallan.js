...
const EmployeeChallan = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      <div>
        <Card>
          <StatusTable className="gc-style-fda4fad5c3">
            <Row label={`${t("UC_CHALLAN_NO")}`} text={challanno} />
            <hr className="gc-style-689d45e4d2" />
            ...
            <hr className="gc-style-689d45e4d2" />
            <Row
              label={<b className="gc-style-fda4fad5c3">{t("PAYMENT_CS_TOTAL_AMOUNT_DUE")}</b>}
              text={`₹${totalDueAmount}`}
              textStyle={{ fontSize: "24px", padding: "10px 0px", fontWeight: "700" }}
            />
          </StatusTable>
          <div className="gc-style-bf62f514a1">{t("SERVICEDETAILS")}</div>
          <StatusTable>
            <Row
          ...
          <div className="gc-style-bf62f514a1">{t("CONSUMERDETAILS")}</div>
          <StatusTable>
