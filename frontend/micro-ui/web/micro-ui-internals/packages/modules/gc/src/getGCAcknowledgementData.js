...
const getAssessmentInfo = (application, t) => {
  let values = [
    ...
    { title: t("PTR_SEARCH_PET_TYPE"), value: application?.petDetails.petType },
    { title: t("PTR_SEARCH_BREED_TYPE"), value: application?.petDetails.breedType },
    ...
    details: [
      {
        ...
        values: [
          { title: t("REPORT_FSM_RESULT_APPLICATION_NO"), value: application?.applicationNumber },
