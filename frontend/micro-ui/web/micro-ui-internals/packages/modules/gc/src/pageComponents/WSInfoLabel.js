...
import { FormStep, RadioOrSelect, RadioButtons, CitizenInfoLabel, InfoBannerIcon } from "@mseva/digit-ui-react-components";
      ...
      {isPrivacyEnabled === "true" && (
        <div style={userType === "citizen" ? { maxWidth: "970px" } : isMobile ? {} : { width: "80%" }}>
          <div
            ...
            style={window.location.href.includes("/connection-details") ? { color: "#3498DB", margin: "0px" } : { color: "#3498DB" }}
          >
            <div>
              <InfoBannerIcon />
