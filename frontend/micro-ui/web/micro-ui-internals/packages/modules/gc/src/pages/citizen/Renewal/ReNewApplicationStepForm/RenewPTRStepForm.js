...
import {
  SET_GCNewApplication_STEP,
  UPDATE_GCNewApplication_FORM,
  RESET_GC_NEW_APPLICATION_FORM,
} from "../../../../redux/action/GCNewApplicationActions";
  ...
  useEffect(() => {
    if (defaultValues) {
      ...
      Object.entries(updatedDefaultValues).forEach(([key, value]) => {
        dispatch(UPDATE_GCNewApplication_FORM(key, value));
      });
    }
  }, [defaultValues]);
