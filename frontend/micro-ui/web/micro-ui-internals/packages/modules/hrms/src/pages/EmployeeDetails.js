import { ActionBar, Card, CardSubHeader, DocumentSVG, Header, Loader, Menu, Row, StatusTable, SubmitBar } from "@mseva/digit-ui-react-components";
          ...
          <Card>
            <StatusTable>
              <Row
                ...
                text={
                  data?.Employees?.[0]?.isActive ? <div className="sla-cell-success"> {t("ACTIVE")} </div> : <div className="sla-cell-error text-body-l">{t("INACTIVE")}</div>
                }
