...
import CancelReceipt from "./pages/employee/CancelReceipt";
import ReceiptAcknowledgement from "./pages/employee/ReceiptAcknowledgement";
...
const componentsToRegister = {
  MCollectConsumerDetails: ConsumerDetails,
  MCollectServiceDetails: ServiceDetails,
  MCollectAddressDetails: AddressDetails,
  MCollectCard,
  MCollectModule,
  MCollectLinks,
  MCollectEmployeeChallanService: EmployeeChallan,
  MCollectAcknowledgementPage: MCollectAcknowledgement,
  MCollectEditChallanPage: EditChallan,
  MCollectNewChallanPage: NewChallan,
  ...
  MCollectSearchReceipt: SearchReceipt,
  MCollectSearchChallan: SearchChallan,
  MCollectSearchBill: SearchBill,
  GroupBill,
  CancelReceipt,
  MCollectReceiptAcknowledgement: ReceiptAcknowledgement,
