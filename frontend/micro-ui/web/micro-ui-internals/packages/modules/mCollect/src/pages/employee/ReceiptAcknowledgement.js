import { ActionBar, Banner, Card, CardText, LinkButton, Loader, SubmitBar } from "@mseva/digit-ui-react-components";
      ...
      {isSuccess && (
        <CardText>
          <LinkButton
            ...
            style={{ width: "100px" }}
            onClick={() => {
              if (state?.action === "CANCEL" || Payment?.paymentStatus === "CANCELLED") {
