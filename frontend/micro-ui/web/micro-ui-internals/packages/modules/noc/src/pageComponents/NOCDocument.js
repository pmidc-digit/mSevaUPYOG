...
const PDFSvg = ({ width = 20, height = 20, className = "" }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 20 20" fill="gray">
...
function NOCDocument({ value = {}}) {
  ...
  return (
    <div className="noc-page-components-nocdocument--style-1">
      <React.Fragment>
        <div className="noc-page-components-nocdocument--style-2">
          {documents?.map((document, index) => {
            ...
            return (
              ...
              className="noc-page-components-nocdocument--style-3"
              key={index}>
                <PDFSvg width={85} height={100} className="noc-page-components-nocdocument--style-4" />
                <p
                 className="noc-page-components-nocdocument--style-5"
                >
