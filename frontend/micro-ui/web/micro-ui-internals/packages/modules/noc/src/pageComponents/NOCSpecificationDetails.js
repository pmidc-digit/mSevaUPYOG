...
const NOCSpecificationDetails = (_props) => {
 ...
 // console.log("nocType here", nocType);
  ...
  useEffect(() => {
    if (existingNocType?.code === "ONLINE" && existingNocNumber && retrievedNocDocs.length === 0 && !isRetrieving) {
  ...
  const isFinalNoc =
    specificationNocType?.code === "FINAL" ||
    specificationNocType?.name === "Final" ||
    specificationNocType === "FINAL";
      ...
      <div>
        ...
        {isFinalNoc && (
          <React.Fragment>
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller
                      ...
                      rules={{
                        required: existingNocType?.code === "OFFLINE" ? t("REQUIRED_FIELD") : false,
                      }}
                      render={(props) => (
                        <TextInput
                          className="form-field"
            ...
            {existingNocType?.code === "ONLINE" && (
              <React.Fragment>
                <LabelFieldPair>
                  <CardLabel className="card-label-smaller">
                    {`${t("NOC_EXISTING_NOC_NUMBER_LABEL")}`} <span className="requiredField">*</span>
                  </CardLabel>
                  <div className="field">
                    <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                      <div style={{ flex: 1 }}>
                        <Controller
                          ...
                          name="existingNocNumber"
                          rules={{
                            required: existingNocType?.code === "ONLINE" ? t("REQUIRED_FIELD") : false,
                            validate: (value) => {
                              if (existingNocType?.code === "ONLINE") {
