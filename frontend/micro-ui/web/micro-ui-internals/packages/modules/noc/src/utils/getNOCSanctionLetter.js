...
const getNOCSanctionLetter = async (application, t) => {
  ...
  const content = `
    ...
    nocDetails?.additionalDetails?.SubmittedOn ? new Date(Number(nocDetails.additionalDetails.SubmittedOn)).toLocaleDateString("en-GB") : "N/A"
          ...
          <p>
            2. Whereas, the area falls under the following categories: -          </p>
          <table>
            <tr>
              <th>Sr. No.</th>
              <th>Details</th>
            ...
            <tr>
              <td>2</td>
              <td>Compounding / Regularization of unauthorized plot</td>
              <td>Plot measuring ${site?.specificationBuildingCategory || "N/A"} ${site?.specificationPlotArea || "N/A"} Sq. mts.</td>
            </tr>
            ${
              site.buildingStatus === "Built Up"
                ? `<tr>
                     <td>3</td>
                     <td>Regularization of Existing Unauthorized building</td>
                     <td>${nocDetails?.builtUpArea || "Details not provided"}</td>
                   </tr>`
                : ""
            }
            ${
                ...
                ? `
                  <tr>
                    ...
                    <td>
                      ...
                      <br/><strong>Total Built-up Area:</strong> ${site?.totalFloorArea} sqft.
                    </td>
                  </tr>
                `
                : ""
            ...
            <tr>
              <td>4</td>
              <td>Full Regularization charges have been paid</td>
              <td>vide No: ${application.applicationNo} Rs. : ${nocDetails?.charges || "N/A"}</td>
            </tr>
          </table>

          ${
            site.specificationNocType === "Provisional"
              ? `<p>
                   3. The Final Regularization Certificate will be issued after scrutinizing the application
                   as per the regularization policy of Department of Housing & Urban Development and other applicable laws. (e.g. plot / building does not fall under High-tension wire)
                 </p>`
              : ""
          }
          
          <p>
          4.	However, the charges levied against these NOC is only regarding regularization of plot / regularization of building and does not include any other pending fee / charges / dues related to any branch / office of Local Government department or any other department.          </p>

          <p>
            5.	However, any new construction / alteration shall be undertaken after getting a building plan sanctioned in accordance with building bye laws applicable at the time of construction.          </p>

          <p>
            6.	In case of any deficiency in charges received at the time of issue of NOC, the applicant shall be liable to pay the same          </p>

          <p>
            7.	The Applicant shall be responsible for any misrepresentation of his/her/their application regarding Para 6 of the policy.          </p>
