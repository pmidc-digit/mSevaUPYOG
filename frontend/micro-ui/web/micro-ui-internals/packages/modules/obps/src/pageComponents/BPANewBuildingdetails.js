        ...
        return (
          <>
            ...
            <div className="field-container">
              ...
              />
              <div
                style={{ position: "relative", zIndex: "100", right: "95px", marginTop: "-24px", marginRight: Webview ? "-20px" : "-20px" }}
                onClick={(e) => onClick(e)}
              >
                {" "}
                <SearchIcon />{" "}
    ...
    <React.Fragment>
      ...
      <FormStep
        ...
        isDisabled={
          ...
          !greenbuilding ||
          !restrictedArea ||
          !proposedSite /* || (approvedColony === "YES" && !nameofApprovedcolony) || (approvedColony === "NO" && !NocNumber)*/
        }
      >
        <div>
