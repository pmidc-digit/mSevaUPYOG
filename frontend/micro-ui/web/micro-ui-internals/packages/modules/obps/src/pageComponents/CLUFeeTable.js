      ...
      render: (row, rowIndex, t) => {
        ...
        return (
          <TextInput
            ...
            type="number"
            isMandatory={false}
            value={feeData[row.index]?.adjustedAmount === null ? "" : feeData[row.index]?.adjustedAmount || row.amount || ""}
            onChange={(e) => {
                    ...
                    <div className="custom-fee-history-card-content">
                      {historyRows.map((h, idx) => (
                        <div key={idx} className="custom-fee-history-entry">
                          ...
                          {h.when && (
                            <div className="custom-fee-history-item">
                              <span className="custom-fee-history-label-bold">{t("BPA_LAST_UPDATED_DATE_LABEL")}:</span>{" "}
                              {new Date(h.when).toLocaleDateString("en-IN")}
                            </div>
                          )}
                          <div className="custom-fee-history-item">
