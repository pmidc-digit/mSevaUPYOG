...
<<<<<<< HEAD
    <div className="layout-summary-page">
      ...
      <h2 className="layout-summary-heading">{t("BPA_APPLICANT_DETAILS")}</h2>
...
>>>>>>> 3466ae1f1365e0729f571d26f41008348acc109e
      ...
      <div className="layout-summary-section">{renderLabel(t("BPA_PLOT_AREA_JAMA_BANDI_LABEL"), formData?.siteDetails?.specificationPlotArea)}</div>

      <h2 className="layout-summary-heading">{t("BPA_SITE_COORDINATES_LABEL")}</h2>
      <div className="layout-summary-section">
      ...
      <h2 className="layout-summary-heading">{t("BPA_TITILE_DOCUMENT_UPLOADED")}</h2>
      <div className="layout-summary-section">
