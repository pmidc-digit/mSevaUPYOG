...
const FeeEstimation = ({
    ...
    return (
        <div>
            ...
            {!hidePayTwo && currentStepData?.createdResponse?.businessService === "BPA_LOW" && (bpaCalculatorLoadingSan ? <Loader /> :<PayTwoTable {...{sanctionFeeDataWithTotal,disable,isEmployee,sanctionFeeData,handleAdjustedAmountChange,onAdjustedAmountBlur,handleFileUpload,handleFileDelete,routeTo, t, handleRemarkChange, enabledEmployee}}/>)}
