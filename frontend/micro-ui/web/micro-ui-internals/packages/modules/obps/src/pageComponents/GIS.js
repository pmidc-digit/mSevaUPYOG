...
const GIS = ({ t, config, onSelect, formData = {}, handleRemove, onSave }) => {
  ...
  return (
    <div className="obps-page-components-gis--style-1">
      <div className="obps-page-components-gis--style-2">
        {console.log("GIS component mounted")}
        ...
        <div style={Webview ? { marginLeft: "25%", marginRight: "25%" } : {}}>
          <LocationSearchCard
            className="obps-page-components-gis--style-3"
