...
const NOCNumber = ({ t, config, onSelect, userType, formData, setError: setFormError, clearErrors: clearFormErrors, formState }) => {
  ...
  return (
    <div>
      ...
      <FormStep t={t} config={config} onSelect={handleSubmit} isDisabled={!nocNumber}>
        <div className="field-container">
          ...
          />
          <div
            style={{ position: "relative", zIndex: "100", right: "20px", marginTop: "-24px", marginRight: Webview ? "-20px" : "-20px" }}
            onClick={(e) => onClick(e)}
          >
            {" "}
            <SearchIcon />{" "}
