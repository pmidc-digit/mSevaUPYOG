...
//   }, [propertyDues, pathname]);
  ...
  return (
    <React.Fragment>
      <div className="obps-page-components-property-search-ludhiana--style-1">
        <LabelFieldPair>
          ...
          <div
            className="field ndc_property_search obps-page-components-property-search-ludhiana--style-2"
          ...
          >
            ...
            {!isSearchClicked && !isLoading && (
              <button className="submit-bar obps-page-components-property-search-ludhiana--style-3" type="button"  onClick={searchProperty}>
                {`${t("PT_SEARCH")}`}
              </button>
            )}
            {isLoading && <Loader />}
