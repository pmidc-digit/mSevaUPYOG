...
//     console.log(layoutObject, "LAYOUTDATA");
//     if (layoutObject) {
...
//   console.log(workflowDetails, "workflow");
...
//       history.push(`/digit-ui/citizen/payment/collect/Layout_mcUp/${appNo}/${tenantId}?tenantId=${tenantId}`)
//     } else {
