...
const LayoutMyApplications = ({ view }) => {
  ...
  const { isLoading, data, isError, error } = Digit.Hooks.obps.useLayoutCitizenSearchApplication(
        ...
        return (
          <div key={`card-${index}`}>
            <Card>
              ...
              <Link to={`/digit-ui/citizen/obps/layout/application-overview/${application?.Applications?.applicationNo}`}>
                <SubmitBar 
