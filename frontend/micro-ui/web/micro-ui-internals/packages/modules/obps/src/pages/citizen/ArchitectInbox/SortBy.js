...
import { ActionBar, RadioButtons, ApplyFilterBar, CloseSvg, SortSvg } from "@mseva/digit-ui-react-components";
      ...
      <div className="filter">
        <div className="filter-card">
          ...
          <div className="heading">
            ...
            <SortSvg />
              {t("SORT_BY")}
              <span className="clear-search obps-pages-citizen-architect-inbox-sort-by--style-1" onClick={clearAll} >
