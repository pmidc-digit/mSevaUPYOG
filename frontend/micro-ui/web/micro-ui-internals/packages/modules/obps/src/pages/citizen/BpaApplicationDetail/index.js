...
//   const { isMdmsLoading, data: mdmsData } = Digit.Hooks.obps.useMDMS(safeTenantId, "BPA", ["RiskTypeComputation"], { enabled: !!safeTenantId });
...
const submitAction = (workflow) => {
  ...
  const payload = { ...app, documents: dedupedDocs, workflow };
