...
const CreateEDCR = ({ parentRoute }) => {
  ...
  async function handleSelect(key, data, skipStep, index) {
                ...
                >
                  <div className="investor-notice-container">
                    ...
                    <p className="notice-body">
                      Please be informed that with effect from 15.05.2025, all building plan applications under the following categories will no
                      longer be accepted on the eNaksha Portal:{" "}
                      <a href="https://enaksha.lgpunjab.gov.in" target="_blank" rel="noopener noreferrer" className="notice-link">
                        https://enaksha.lgpunjab.gov.in
                      </a>{" "}
                      and{" "}
                      <a href="https://mseva.lgpunjab.gov.in/" target="_blank" rel="noopener noreferrer" className="notice-link">
                    ...
                    <p className="notice-body">
                      Instead, investors are requested to submit such applications exclusively through the Punjab Bureau of Investment Promotion
                      (PBIP) Portal:
                    </p>
                    <p className="notice-body-link">
                      <a href="https://fasttrack.punjab.gov.in/webportal/login" target="_blank" rel="noopener noreferrer" className="notice-link">
                        https://fasttrack.punjab.gov.in/webportal/login
                      </a>
                    </p>
                    <p className="notice-body">We request all stakeholders to kindly take note of this change and plan submissions accordingly.</p>
