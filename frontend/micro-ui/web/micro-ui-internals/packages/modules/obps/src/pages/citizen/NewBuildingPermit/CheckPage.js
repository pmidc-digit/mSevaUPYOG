      ...
      <Card style={{ paddingRight: "16px" }}>
        ...
        <div key={index}>
          ...
          <TextInput
            ...
            value={development}
            onChange={(e) => {
              setDevelopment(e.target.value), sessionStorage.setItem("development", e.target.value);
            }}
          ...
          <TextInput
            ...
            value={otherCharges}
            onChange={(e) => {
              setOtherCharges(e.target.value), sessionStorage.setItem("otherCharges", e.target.value);
            }}
            //disable={userInfo?.info?.emailId && !isOpenLinkFlow ? true : false}
            //disable={editScreen}
            //{...{ required: true, pattern: "[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$", type: "email", title: t("CORE_COMMON_APPLICANT_MOBILE_NUMBER_INVALID") }}
          ...
          <TextInput
            ...
            value={lessAdjusment}
            onChange={(e) => {
              setLessAdjusment(e.target.value), sessionStorage.setItem("lessAdjusment", e.target.value);
            }}
            //disable={userInfo?.info?.emailId && !isOpenLinkFlow ? true : false}
            //disable={editScreen}
            //{...{ required: true, pattern: "[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$", type: "email", title: t("CORE_COMMON_APPLICANT_MOBILE_NUMBER_INVALID") }}
