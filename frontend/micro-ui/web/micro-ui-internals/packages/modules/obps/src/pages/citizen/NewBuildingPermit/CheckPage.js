    ...
    <React.Fragment>
      ...
      <Card style={{ paddingRight: "16px" }}>
        <StatusTable>
          ...
          <Row
            ...
            text={datafromAPI?.planDetail?.planInfoProperties?.KHATA_NO || t("CS_NA")}
          />
          ...
          <Row
            ...
            text={data?.khasraNumber || value?.additionalDetails?.khasraNumber || t("CS_NA")}
          />
          <Row
            className="border-none"
      ...
      <Card style={{ paddingRight: "16px" }}>
        ...
        {/* <Row
          ...
          <Row
            className="border-none"
            label={t("BPA_SCRUTINY_DETAILS_NUMBER_OF_FLOORS")}
