import { Banner, Card, SubmitBar, CardText } from "@mseva/digit-ui-react-components";
    ...
    <div>
      <Card>
        <Banner
          message={
            getAppAction == "BPA_SUBMIT_APP"
              ? t(`BPA_SUBMIT_HEADER_${bpaBusinessService}_${bpaAction}_${stringReplaceAll(bpaStatus, " ", "_").toUpperCase()}`)
              : t(`BPA_HEADER_${bpaBusinessService}_${bpaAction}_${stringReplaceAll(bpaStatus, " ", "_").toUpperCase()}`)
          }
        ...
        <CardText>
          {getAppAction == "BPA_SUBMIT_APP"
            ? t(
                `BPA_SUBMIT_SUB_HEADER_${bpaBusinessService}_${bpaAction}_${typeOfArchitect ? typeOfArchitect : "ARCHITECT"}_${stringReplaceAll(
                  bpaStatus,
                  " ",
                  "_"
                ).toUpperCase()}`
            ...
            : t(
                `BPA_SUB_HEADER_${bpaBusinessService}_${bpaAction}_${typeOfArchitect ? typeOfArchitect : "ARCHITECT"}_${stringReplaceAll(
                  bpaStatus,
                  " ",
                  "_"
                ).toUpperCase()}`
