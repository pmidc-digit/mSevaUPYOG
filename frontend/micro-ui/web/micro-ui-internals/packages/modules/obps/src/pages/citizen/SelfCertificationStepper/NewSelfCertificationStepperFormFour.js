...
const NewSelfCertificationStepFormFour = ({ config, onGoNext, onBackClick }) => {
  ...
  return (
    <React.Fragment>
      <LocationDetails onGoBack={onGoBack} onSelect={goNext} formData={scrutinyDetails} t={t} currentStepData={currentStepData}/>
      <div></div>
...
export default NewSelfCertificationStepFormFour;
