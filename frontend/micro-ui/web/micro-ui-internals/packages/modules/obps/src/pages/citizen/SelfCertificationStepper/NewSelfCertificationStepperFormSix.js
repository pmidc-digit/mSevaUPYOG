...
const NewSelfCertificationStepFormSix = ({ config, onGoNext, onBackClick }) => {
  ...
  return (
    <React.Fragment>
      <OwnerDetails onGoBack={onGoBack} onSelect={goNext} formData={scrutinyDetails} t={t} currentStepData={currentStepData}/>
      <div></div>
...
export default NewSelfCertificationStepFormSix;
