...
//   // <CHANGE> Pass the action to your existing onSubmit
//   if (onSubmit) {
//     onSubmit(action); // Your onSubmit will handle adding action to payload
//   }
// }
...
//   console.log("formPay",paymentDetails)
...
const CheckPage = ({ onSubmit, value }) => {
  ...
  console.log("isBPAREGLoading:", isBPAREGLoading)
  console.log("bparegData:", bparegData)

  console.group("🔍 [v0] WORKFLOW DEBUG - BEFORE HOOK CALL")
  console.log("moduleCode being passed:", moduleCode || "ENGINEER")
  console.log("tenantId:", tenantId)
  console.log("id (applicationNo):", applicationNo || id)
  console.log("Full hook params:", {
    tenantId,
    id: applicationNo || id,
    moduleCode: moduleCode || "ENGINEER",
  })
  ...
  console.group("🔍 [v0] WORKFLOW DEBUG - AFTER HOOK CALL")
  console.log("workflowDetails response:", workflowDetails)
  console.log("workflowDetails.data:", workflowDetails?.data)
  console.log("Is loading:", workflowDetails?.isLoading)
  console.groupEnd()
  ...
  console.group("🧾 [BPA REG CHECK PAGE DEBUG]")
  console.log("Consumer Code:", consumerCode)
  console.log("Fetch Bill Params:", fetchBillParams)
  console.log("Tenant ID:", tenant || tenantId.split(".")[0])
  console.log("Is Loading:", isLoading)
  console.log("Payment Details Response:", paymentDetails)
  console.log("Form Data:", formData)
  console.log("License Status:", formData?.result?.Licenses?.[0]?.status)
  console.log("Bill Amount:", paymentDetails?.billResponse?.Bill?.[0]?.billDetails?.[0]?.amount)
  console.groupEnd()
  ...
  function onActionSelect(action) {
    console.log("[v0] Selected action:", action)
    setDisplayMenu(false)
