...
import { OBPSIconSolidBg, EmployeeModuleCard } from "@mseva/digit-ui-react-components";
...
const OBPSEmployeeHomeCard = () => {
  ...
  const stakeholderEmployeeRoles = [
    { code: "BPAREG_DOC_VERIFIER", tenantId: stateCode },
    { code: "BPAREG_APPROVER", tenantId: stateCode },
  ];
