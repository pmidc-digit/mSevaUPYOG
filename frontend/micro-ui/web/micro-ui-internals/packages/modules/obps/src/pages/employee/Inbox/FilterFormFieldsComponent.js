...
const FilterFormFieldsComponent = ({
  ...
  const selectedBusinessService = useWatch({
    control: controlFilterForm,
    name: "businessService",
    defaultValue: filterFormState?.businessService || null,
  });
  ...
  return (
    <>
      ...
      {selectedApplicationType?.length > 0 && selectedApplicationType != "BUILDING_OC_PLAN_SCRUTINY" ? (
        <FilterFormField>
          <Controller
            name="businessService"
            control={controlFilterForm}
