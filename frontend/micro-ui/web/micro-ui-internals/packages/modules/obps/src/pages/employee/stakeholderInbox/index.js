...
const Inbox = ({ parentRoute }) => {
  ...
  const { control: controlFilterForm, setValue: setFilterFormValue, getValues: getFilterFormValue } = useForm({
            ...
            <div className="filter-drawer-overlay" onClick={() => setShowFilterDrawer(false)}>
              <div className="filter-drawer" onClick={(e) => e.stopPropagation()}>
                <div className="filter-drawer-header">
                  ...
                  <button className="filter-drawer-close" onClick={() => setShowFilterDrawer(false)} aria-label="Close filters">
                    ✕
                  </button>
                </div>
                ...
                <div className="filter-drawer-footer">
                  <button className="filter-apply-btn" onClick={() => setShowFilterDrawer(false)}>
                    {t("COMMON_APPLY")}
                  </button>
                </div>
              </div>
