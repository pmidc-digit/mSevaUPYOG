import { Banner, Card, ActionBar, SubmitBar, Toast } from "@mseva/digit-ui-react-components";
...
const PropertyResponseCitizen = (props) => {
    ...
    <div>
      <Card>
        <Banner
          ...
          message={t("Property Has Been Generated Successfully")}
...
export default PropertyResponseCitizen;
