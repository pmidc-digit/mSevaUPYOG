...
const NewPTStepFormTwo = ({ config, onGoNext, onBackClick }) => {
  ...
  return (
    <React.Fragment>
      <div className="employeeCard">
        <PropertyDetails onGoBack={onGoBack} goNext={goNext} currentStepData={currentStepData} t={t} />
...
export default NewPTStepFormTwo;
