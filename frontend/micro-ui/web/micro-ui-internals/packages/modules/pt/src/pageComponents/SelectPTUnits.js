import { CardLabel, Dropdown, FormStep, LinkButton, Loader, TextInput, DeleteIcon } from "@mseva/digit-ui-react-components";
...
const formatUnits = (units = [], currentFloor, isFloor) => {
  ...
  return units.map((unit) => {
    ...
    return {
      ...unit,
      builtUpArea: Math.round(Number(unit?.constructionDetail?.builtUpArea) * 9).toFixed(2),
