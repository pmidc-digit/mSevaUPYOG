import { Loader, Modal, Card, CardHeader, StatusTable, Row } from "@mseva/digit-ui-react-components";
              ...
              <Card>
                ...
                <StatusTable>
                  ...
                  <Row
                    label={t("CR_ADDRESS")}
                    text={
                      propertyData?.Properties?.[0]?.address?.doorNo +
                        ", " +
                        propertyData?.Properties?.[0]?.address?.locality?.name +
                        ", " +
                        propertyData?.Properties?.[0]?.address?.city || "NA"
                    }
                  />
                </StatusTable>
              </Card>
