...
const App = () => {
  ...
  const PTTransferOwnership = Digit?.ComponentRegistryService?.getComponent("PTCitizenTransferOwnership");
  const PTResponse = Digit?.ComponentRegistryService?.getComponent("PTResponse");
