    ...
    <React.Fragment>
      <div className="filter">
        <div className="filter-card">
          <div className="heading ptr-style-7c61974051">
            <div className="filter-label ptr-style-0e1a6d017b">
              <span>
              ...
              <span className="ptr-style-fda6fb0beb">{t("ES_COMMON_FILTER_BY")}:</span>
            </div>
            <div className="clearAll" onClick={clearAll}>
              {t("ES_COMMON_CLEAR_ALL")}
            </div>
            {props.type === "desktop" &&
            <span className="clear-search ptr-style-4af588be19" onClick={clearAll}>
