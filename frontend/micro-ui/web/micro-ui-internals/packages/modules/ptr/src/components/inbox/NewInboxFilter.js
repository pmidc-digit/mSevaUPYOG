    ...
    <React.Fragment>
      <div className="filter">
        <div className="filter-card">
          <div className="heading ptr-filter-heading">
            <div className="filter-label ptr-filter-label-container">
              <span>
              ...
              <span className="ptr-filter-label-text">{t("ES_COMMON_FILTER_BY")}:</span>
            </div>
            <div className="clearAll" onClick={clearAll}>
              {t("ES_COMMON_CLEAR_ALL")}
            </div>
            {props.type === "desktop" && (
              <span className="clear-search ptr-filter-clear-search-icon" onClick={clearAll}>
