    ...
    <React.Fragment>
      <div className="ptr-style-87c136dfd0">
        <div className="ptr-style-cbc09ef471">
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.petType ? errors?.petType?.message : ""}</CardLabelError>
          <LabelFieldPair>
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.breedType ? errors?.breedType?.message : ""}</CardLabelError>
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.petName ? errors?.petName?.message : ""}</CardLabelError>
          ...
          <div className="ptr-style-91a87015f4">
          ...
          <br></br>
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.petAge ? errors?.petAge?.message : ""}</CardLabelError>
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.petGender ? errors?.petGender?.message : ""}</CardLabelError>
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.doctorName ? errors?.doctorName?.message : ""}</CardLabelError>
          <LabelFieldPair>
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.clinicName ? errors?.clinicName?.message : ""}</CardLabelError>
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.lastVaccineDate ? errors?.lastVaccineDate?.message : ""}</CardLabelError>
          ...
          <CardLabelError className="ptr-form-field-error">{localFormState.touched.vaccinationNumber ? errors?.vaccinationNumber?.message : ""}</CardLabelError>
        </div>
      </div>
      {showToast?.label &&
      <Toast
