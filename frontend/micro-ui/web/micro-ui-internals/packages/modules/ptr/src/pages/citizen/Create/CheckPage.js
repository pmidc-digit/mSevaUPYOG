import { Card, CardHeader, CardSubHeader, CardText, CheckBox, LinkButton, Row, StatusTable, SubmitBar } from "@mseva/digit-ui-react-components";
...
const CheckPage = ({ onSubmit, value = {} }) => {
  ...
  const { address, pets, index, isEditPET, isUpdatePET, ownerss } = value;
