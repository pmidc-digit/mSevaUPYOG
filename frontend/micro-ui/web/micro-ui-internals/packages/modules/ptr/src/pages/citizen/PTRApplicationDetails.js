  ...
  flex-shrink: 1;         }
            ...
            <body>
              ...
              <div class="header-right">
                ...
                <span class="detail-value">This is to certify that the ${petData?.petDetails?.petType || "Dog"} kept by Mr./Mrs./Ms. ${petData?.owner?.name || "Not Specified"} at (Address) ${petData?.address?.addressId || "Not Specified"}, ${petData?.address?.pincode || ""} mobile no. ${petData?.owner?.mobileNumber || "Not Specified"} is registered with Municipal Corporation ${ulb} as per following details:</span>
            ...
            <body>
              <div class="acknowledgement-container">
                <div class="header">
                  ...
                  <div class="subtitle">Municipal Corporation ${ulb}</div>
                </div>
