...
const DesktopInbox = ({ tableConfig, filterComponent, columns, ...props }) => {
  ...
  return (
    <div className="inbox-container ral-style-16a8a8b00c">
      {!props.isSearch &&
      ...
      <div className="ral-style-7623f05545">
        <SearchApplication
          defaultSearchParams={props.defaultSearchParams}
        ...
        <div className={`result ral-desktop-inbox__result${!props?.isSearch ? " ral-desktop-inbox__result--inbox" : ""}`}>
          {result}
        </div>
      </div>
    </div>);
