    ...
    <React.Fragment>
      <div className="filter">
        <div className="filter-card">
          <div className="heading ral-style-1ca832ca6c">
            <div className="filter-label ral-style-44b6015a79">
              <span>
              ...
              <span className="ral-style-8119d65878">{t("ES_COMMON_FILTER_BY")}:</span>
            </div>
            <div className="clearAll" onClick={clearAll}>
              {t("ES_COMMON_CLEAR_ALL")}
            </div>
            {props.type === "desktop" &&
            <span className="clear-search ral-style-806dcbc2f3" onClick={clearAll}>
            ...
            <div>
                ...
                <span className="clear-search ral-style-26afc10d19" onClick={Refresh}>
                  <RefreshSVG />
                </span>
              </div>
            }
            ...
            <div>
              <Status
                ...
                onAssignmentChange={(e, status) => {
                  if (e.target.checked) localParamChange({ applicationStatus: [...(_searchParams?.applicationStatus || []), status] });else
                  {
