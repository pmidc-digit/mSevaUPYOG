...
const ServiceDetails = ({ config, onSelect, userType, formData, setError, formState, clearErrors }) => {
  ...
  const { Categories: categoires, data: categoriesandTypes } = Digit.Hooks.mcollect.useMCollectCategory(
    tenantId,
...
const OwnerForm1 = (_props) => {
  ...
  return (
    <div className={isMobile ? "" : "ral-desktop-margin-top"}>
      <div className="ral-service-details-wrapper">
        <div>
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller
                      ...
                      render={(props) => (
                        <div className="ral-tax-head-input-container">
