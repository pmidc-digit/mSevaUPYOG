...
const RALInboxSearch = ({ values, onSearch }) => {
  ...
  return (
    <form
      className="new-inbox-topbar ral-new-inbox-search"
      onSubmit={(event) => {
        event.preventDefault();
        onSearch(searchValues);
      }}
    >
      <div className="ral-new-inbox-search-fields">
        <label>
      ...
      <div className="ral-new-inbox-search-actions">
        <button type="submit" className="ral-new-inbox-search-button">
          {t("ES_COMMON_SEARCH")}
        </button>
        <button type="button" className="ral-new-inbox-clear-button" onClick={clearSearch}>
