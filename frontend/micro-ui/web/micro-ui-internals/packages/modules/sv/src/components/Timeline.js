...
let actions = [
  "SV_VENDOR_PERSONAL_DETAILS",
  "SV_VENDOR_BUSINESS_DETAILS",
  "SV_ADDRESS_DETAILS",
  "SV_BANK_DETAILS",
  "SV_DOCUMENT_DETAILS_LABEL",
  "SV_SPECIAL_CATEGORY",
  "SV_SUMMARY_PAGE",
];
    ...
    <div
      ...
      style={
        isMobile
          ? {}
          : user?.type === "EMPLOYEE"
          ? { maxWidth: "960px", minWidth: "640px", marginRight: "auto", marginLeft: "auto", display: "flex", justifyContent: "center" }
          : { maxWidth: "960px", minWidth: "640px", marginRight: "auto", display: "flex", justifyContent: "center" }
      }
    >
