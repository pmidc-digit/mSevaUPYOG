import { CardSectionHeader, CheckPoint, ConnectingCheckPoints, Loader, SubmitBar } from "@mseva/digit-ui-react-components";
      ...
      case "PAY":
        return props?.userType === "citizen" ? (
          <div style={{ marginTop: "1em", bottom: "0px", width: "100%", marginBottom: "1.2em" }}>
            <Link
              to={{
                pathname: `/digit-ui/citizen/payment/my-bills/sv-services/${props?.application?.applicationNo}`,
                  ...
                  return (
                    <React.Fragment key={index}>
                      <CheckPoint
                        ...
                        label={t(`SV_${data?.processInstances[index].state?.["state"]}${timelineStatusPostfix}`)}
