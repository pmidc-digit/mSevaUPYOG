...
import { Dropdown, CloseSvg, SubmitBar } from "@mseva/digit-ui-react-components";
        ...
        <div className="filter-card">
          ...
          <div>
            <div>
              ...
              <div>
                <Dropdown selected={_vendingZone} select={setVendingZone} option={vending_Zone} optionKey="i18nKey" t={t} placeholder={"Select"} />
              </div>
            ...
            <div>
              ...
              <div>
                <Dropdown selected={app_status} select={setAppStatus} option={StatusFields} optionKey="i18nKey" t={t} placeholder={"Select"} />
              </div>
            </div>
