...
import { FormStep, TextInput, CardLabel, CardHeader, Dropdown, TextArea, CheckBox } from "@mseva/digit-ui-react-components";
...
const SVAdrressDetails = ({ t, config, onSelect, userType, formData, editdata, previousData }) => {
  ...
  const [pincode, setPincode] = useState(
    formData?.address?.pincode || previousData?.addressDetails?.[0]?.pincode || editdata?.addressDetails?.[0]?.pincode || ""
  );
  const [city, setCity] = useState(
    formData?.address?.city || convertToObject(previousData?.addressDetails?.[0]?.city || editdata?.addressDetails?.[0]?.city) || ""
  );
  const [locality, setLocality] = useState(
    formData?.address?.locality || convertToObject(previousData?.addressDetails?.[0]?.locality || editdata?.addressDetails?.[0]?.locality) || ""
  );
  const [houseNo, setHouseNo] = useState(
    formData?.address?.houseNo || previousData?.addressDetails?.[0]?.houseNo || editdata?.addressDetails?.[0]?.houseNo || ""
  );
  const [landmark, setLandmark] = useState(
    formData?.address?.landmark || previousData?.addressDetails?.[0]?.landmark || editdata?.addressDetails?.[0]?.landmark || ""
  );
  const [addressline1, setAddressline1] = useState(
    formData?.address?.addressline1 || previousData?.addressDetails?.[0]?.addressLine1 || editdata?.addressDetails?.[0]?.addressLine1 || ""
  );
  const [addressline2, setAddressline2] = useState(
    formData?.address?.addressline2 || previousData?.addressDetails?.[0]?.addressLine2 || editdata?.addressDetails?.[0]?.addressLine2 || ""
  );

  // states for the correspondence address input fields
  const [cpincode, setCPincode] = useState(
    formData?.correspondenceAddress?.cpincode || previousData?.addressDetails?.[1]?.pincode || editdata?.addressDetails?.[1]?.pincode || ""
  );
  const [ccity, setCCity] = useState(
    formData?.correspondenceAddress?.ccity || convertToObject(previousData?.addressDetails?.[1]?.city || editdata?.addressDetails?.[1]?.city) || ""
  );
  const [clocality, setCLocality] = useState(
    formData?.correspondenceAddress?.clocality ||
      convertToObject(previousData?.addressDetails?.[1]?.locality || editdata?.addressDetails?.[1]?.locality) ||
      ""
  );
  const [chouseNo, setCHouseNo] = useState(
    formData?.correspondenceAddress?.chouseNo || previousData?.addressDetails?.[1]?.houseNo || editdata?.addressDetails?.[1]?.houseNo || ""
  );
  const [clandmark, setCLandmark] = useState(
    formData?.correspondenceAddress?.clandmark || previousData?.addressDetails?.[1]?.landmark || editdata?.addressDetails?.[1]?.landmark || ""
  );
  const [caddressline1, setCAddressline1] = useState(
    formData?.correspondenceAddress?.caddressline1 ||
      previousData?.addressDetails?.[1]?.addressLine1 ||
      editdata?.addressDetails?.[1]?.addressLine1 ||
      ""
  );
  const [caddressline2, setCAddressline2] = useState(
    formData?.correspondenceAddress?.caddressline2 ||
      previousData?.addressDetails?.[1]?.addressLine2 ||
      editdata?.addressDetails?.[1]?.addressLine2 ||
      ""
  );
  const [isAddressSame, setIsAddressSame] = useState(
    formData?.correspondenceAddress?.isAddressSame ||
      previousData?.addressDetails?.[1]?.isAddressSame ||
      editdata?.addressDetails?.[1]?.isAddressSame ||
      false
  );
    ...
    return (
      <React.Fragment>
        ...
        >
          <div>
            <CardLabel>
              {`${t("SV_HOUSE_NO")}`} <span className="astericColor">*</span>
            </CardLabel>
            <TextInput
              t={t}
              type={"text"}
            ...
            <CardLabel>
              {`${t("SV_ADDRESS_LINE1")}`} <span className="astericColor">*</span>
            </CardLabel>
            <TextInput
              t={t}
              type={"text"}
            ...
            <CardLabel>
              {`${t("SV_ADDRESS_LINE2")}`} <span className="astericColor">*</span>
            </CardLabel>
            <TextInput
              t={t}
              type={"text"}
            ...
            />
            <CardLabel>
              {`${t("SV_ADDRESS_PINCODE")}`} <span className="astericColor">*</span>
            </CardLabel>
            <TextInput
              t={t}
              type="tel"
