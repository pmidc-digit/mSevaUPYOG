import { Banner, Card, CardText, LinkButton, LinkLabel, Loader, Row, StatusTable, SubmitBar } from "@mseva/digit-ui-react-components";
...
const GetActionMessage = (props) => {
  ...
  } else if (!props.isSuccess) return t("SV_APPLICATION_FAILED");
};
...
const SVAcknowledgement = ({ data, onSuccess }) => {
  ...
  useEffect(() => {
    try {
      ...
      let formdata = window.location.href.includes("edit") ? svUpdatePayload(data, t) : svPayloadData(data);
