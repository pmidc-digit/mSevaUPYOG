  ...
  return (
    <React.Fragment>
      <div>
        ...
        <Card>
          <StatusTable>
            <Row className="border-none" label={t("SV_APPLICATION_NUMBER")} text={streetVendingDetails?.applicationNo} />
          </StatusTable>
          ...
          <StatusTable>
            ...
            <Row
              ...
              text={streetVendingDetails?.vendorDetail?.[0]?.mobileNo || t("CS_NA")}
            />
