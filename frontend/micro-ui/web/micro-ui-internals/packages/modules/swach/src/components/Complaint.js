...
import { Card, DateWrap, KeyNote } from "@mseva/digit-ui-react-components";
import { CardSubHeader } from "@mseva/digit-ui-react-components";
  ...
  return (
    <React.Fragment>
      <Card onClick={handleClick}>
        <CardSubHeader>{t(`SWACHBHARATCATEGORY.${serviceCode.toUpperCase()}`)}</CardSubHeader>
