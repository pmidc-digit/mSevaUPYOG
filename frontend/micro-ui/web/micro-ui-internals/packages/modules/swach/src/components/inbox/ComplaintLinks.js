...
const ComplaintsLink = ({ isMobile, data }) => {
  ...
  const allLinks = [
    { text: "ES_SWACH_NEW_COMPLAINT", link: "/digit-ui/employee/swach/complaint/create", accessTo: ["CSR"] },
  ...
  const GetLogo = () => (
    <div className="header">
      ...
      <span className="text swach-link-card">{t("ES_SWACH_HEADER_COMPLAINT")}</span>
    </div>
  );
