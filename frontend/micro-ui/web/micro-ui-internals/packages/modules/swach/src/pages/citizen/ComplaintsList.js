...
import { Card, Header, Loader } from "@mseva/digit-ui-react-components";
...
export const ComplaintsList = (props) => {
  ...
  let { isLoading, error, data, revalidate } = Digit.Hooks.swach.useComplaintsListByMobile(tenantId, mobileNumber);
