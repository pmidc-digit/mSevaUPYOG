...
const Response = (props) => {
  ...
  return (
    <Card>
      ...
      {appState.complaints.response?.ServiceWrappers?.[0]?.workflow.action == "RATE" ?"": <div className="mb-2.5"><SubmitBar label={t("PT_DOWNLOAD_ACK_FORM")} onSubmit={(e) =>{handleDownloadPdf(e)}} /></div>}
