...
const getSWACHcknowledgementData = async (complaintDetails,tenantInfo, t) => {
      ...
      return {
        ...
        details: [
          ...
          {
            title: t("SWACH_ADDRESS_SUB_HEADER"),
            values: [
              { title: t("SWACH_ADDRESS_PINCODE"), value: complaintDetails?.service?.address?.pincode || t("CS_NA") },
              ...
              { title: t("SWACH_ADDRESS_STREET_NAME"), value: complaintDetails?.service?.address?.street || t("CS_NA") },
              { title: t("SWACH_ADDRESS_HOUSE_NO"), value: complaintDetails?.service?.address?.doorNo || t("CS_NA") },
              { title: t("SWACH_ADDRESS_LANDMARK"), value: complaintDetails?.service?.address?.landmark || t("CS_NA") },
            ],
          },
  ...
  export default getSWACHcknowledgementData;