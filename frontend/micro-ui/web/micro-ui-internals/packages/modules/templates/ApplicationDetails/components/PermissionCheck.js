import { CheckBox, LinkButton, TextInput,Close, CardSubHeader } from "@mseva/digit-ui-react-components";
...
const PermissionCheck = ({ permissions, t }) => {
  ...
  return (
    <div>
      ...
      <LinkButton style={{ maxWidth: isMobile ? "fit-content" : "10%", /* float: "right", marginTop: "-50px", */ marginRight: "3%" }} label={t(`BPA_ADD_MORE`)} onClick={handleAdd} />
    </div>
  )
}
