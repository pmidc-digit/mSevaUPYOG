...
export const configSVApproverApplication = ({
  t,
  action,
  selectFile,
  uploadedFile,
        ...
        body: [
          action?.action === "APPROVE" || action?.action === "REJECT" || action?.action === "SENDBACKTOCITIZEN"
            ...
            : {
                label: t("SV_ASSIGNEE"),
                type: "dropdown",
                populators: <Dropdown option={approvers} t={t} optionKey="name" select={setSelectedApprover} selected={selectedApprover} />,
              },
          {
