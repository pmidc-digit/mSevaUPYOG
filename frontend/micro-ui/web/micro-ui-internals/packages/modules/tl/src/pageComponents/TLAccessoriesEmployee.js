          ...
          <LabelFieldPair>
            ...
            <div className="form-field">
              <Controller
                ...
                rules={
                  accessor?.accessoryCategory?.uom && {
                    required: t("REQUIRED_FIELD"),
                    validate: (e) =>
                      /*(e && getPattern("UOMValue").test(e))*/ e > 0 && e < 99999
                        ? checkRangeForUomValue(e, accessor?.accessoryCategory?.fromUom, accessor?.accessoryCategory?.toUom)
                          ? true
                          : `${t("ERR_WRONG_UOM_VALUE")} ${accessor?.accessoryCategory?.fromUom} - ${accessor?.accessoryCategory?.toUom}`
          ...
          <LabelFieldPair>
            ...
            <div className="form-field">
              <Controller
                ...
                rules={
                  accessor?.accessoryCategory?.code && {
                    required: t("REQUIRED_FIELD"),
