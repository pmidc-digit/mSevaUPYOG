            ...
            <div style={{ marginBottom: "16px" }}>
                <div>
                    ...
                    {!plumberDetail?.detailsProvidedBy?.code || plumberDetail?.detailsProvidedBy?.code == "ULB" ?
                        <div>
                            <LabelFieldPair>
                                <CardLabel style={isMobile && isEmployee ? {fontWeight: "700", width:"100%"} : { marginTop: "-5px", fontWeight: "700" }} className="card-label-smaller">{`${t("WS_ADDN_DETAILS_PLUMBER_LICENCE_NO_LABEL")}`}</CardLabel>
                                <div className="field">
                                    <Controller
                                        control={control}
                                        ...
                                        // rules={{ required: t("REQUIRED_FIELD") }}
                                        rules={{ validate: (e) => ((e && getPattern("WSOnlyNumbers").test(e)) || !e ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG")) }}
                                        isMandatory={false}
                                        render={(props) => (
                                            <TextInput
                                                value={props.value}
                            ...
                            <LabelFieldPair>
                                ...
                                <div className="field">
                                    <Controller
                                        ...
                                        // rules={{ required: t("REQUIRED_FIELD") }}
                                        rules={{ validate: (e) => ((e && getPattern("Name").test(e)) || !e ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG"))}}
                                        isMandatory={false}
                                        render={(props) => (
                                            <TextInput
                                                value={props.value}
                            ...
                            <LabelFieldPair>
                                <CardLabel style={isMobile && isEmployee ? {fontWeight: "700", width:"100%"} : { marginTop: "-5px", fontWeight: "700" }} className="card-label-smaller">{`${t("WS_ADDN_DETAILS_PLUMBER_MOB_NO_LABEL")}`}</CardLabel>
                                <div className="field">
                                    <Controller
                                        control={control}
                                        ...
                                        // rules={{ required: t("REQUIRED_FIELD") }}
                                        rules={{ validate: (e) => ((e && getPattern("MobileNoWithPrivacy").test(e)) || !e || e.includes("*") ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG"))}}
                                        type="mobileNumber"
                                        isMandatory={false}
                                        render={(props) => (
