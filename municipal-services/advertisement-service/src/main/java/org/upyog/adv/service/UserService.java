...
public class UserService {
	 ...
	 */
	public UserResponse getUser(AdvertisementSearchCriteria criteria, RequestInfo requestInfo) {
	 ...
	 */
	private UserSearchRequest getUserSearchRequest(AdvertisementSearchCriteria criteria, RequestInfo requestInfo) {
		...
		List<String> userIds = criteria.getOwnerIds();
