...
public class OwnerInfo extends User{
	...
	public OwnerInfo documents(List<DocumentDetail> documents) {
		this.documents = documents;
		return this;
	}

	public OwnerInfo addDocumentsItem(DocumentDetail documentsItem) {
		if (this.documents == null) {
			this.documents = new ArrayList<DocumentDetail>();
		}
