...
///// added compalsary field for create property
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, landInfo.id) && Objects.equals(this.landUId, landInfo.landUId)
				...
				&& Objects.equals(this.noOfFloors, landInfo.noOfFloors)
				&& Objects.equals(this.landArea, landInfo.landArea)
				&& Objects.equals(this.propertyType, landInfo.propertyType)
				&& Objects.equals(this.usageCategory, landInfo.usageCategory);
	}
	...
	public int hashCode() {
		return Objects.hash(id, landUId, landUniqueRegNo, tenantId, status, address, ownershipCategory, owners,
				institution, source, channel, documents, unit, additionalDetails, auditDetails,noOfFloors,landArea,propertyType,usageCategory);
	}
