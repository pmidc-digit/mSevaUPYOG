...
public class ChallanConfiguration {
    ...
    @Value("${persister.update.echallan.topic}")
    ...
    @Value("${egov.echallan.default.limit}")
    private Integer defaultLimit;

    @Value("${egov.echallan.default.offset}")
    private Integer defaultOffset;

    @Value("${egov.echallan.max.limit}")
