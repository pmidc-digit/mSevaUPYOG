...
public class CLUConstants {
	...
	public static final String MDMS_TAX_PERIOD_FROM_PATH  = "$.MdmsRes.clu.ChargesType.*.startingDate";
	
	public static final String MDMS_TAX_PERIOD_TO_PATH  = "$.MdmsRes.clu.ChargesType.*.endingDate";
