...
public class CLUController {
	...
	public ResponseEntity<CluResponse> create(@Valid @RequestBody CluRequest nocRequest) {
		List<Clu> nocList = nocService.create(nocRequest);
		CluResponse response = CluResponse.builder().noc(nocList)
	...
	public ResponseEntity<CluResponse> update(@Valid @RequestBody CluRequest nocRequest) {
		List<Clu> nocList = nocService.update(nocRequest);
		CluResponse response = CluResponse.builder().noc(nocList)
				.responseInfo(responseInfoFactory.createResponseInfoFromRequestInfo(nocRequest.getRequestInfo(), true))
				.build();
		return new ResponseEntity<>(response, HttpStatus.OK);
	...
	public ResponseEntity<CluResponse> search(@Valid @RequestBody RequestInfoWrapper requestInfoWrapper,
											  @Valid @ModelAttribute LayoutSearchCriteria criteria) {

		List<Clu> nocList = nocService.search(criteria, requestInfoWrapper.getRequestInfo());
