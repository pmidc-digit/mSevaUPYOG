...
public class CluRequest {
  ...
  public CluRequest requestInfo(RequestInfo requestInfo) {
  ...
  **/
  @ApiModelProperty(value = "")
    ...
    @Valid
    public Clu getLayout() {
    return layout;
  }

  public void setLayout(Clu layout) {
    this.layout = layout;
  }
  ...
  public boolean equals(Object o) {
    ...
    CluRequest nocRequest = (CluRequest) o;
