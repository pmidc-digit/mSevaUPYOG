...
var options = {
  ...
  protocol: ["roundrobin"],
  fromOffset: process.env.KAFKA_OFFSET || "earliest",
...
const CONCURRENCY_LIMIT = parseInt(process.env.KAFKA_CONCURRENCY) || 3;
const DLQ_TOPIC = process.env.KAFKA_TOPICS_FIRENOC_DLQ || "firenoc.dlq";
