...
import org.egov.gccalculation.repository.rowmapper.BillGenerateSchedulerRowMapper;
	...
	public void insertBillSchedulerConnectionStatus(List<String> consumerCodes, String scheduler_id, 
		...
		try {
			...
			consumerCodes.forEach(consumercode -> {
				...
				int rows = jdbcTemplate.update(GCCalculatorQueryBuilder.EG_GC_BILL_SCHEDULER_CONNECTION_STATUS_INSERT, new PreparedStatementSetter() {
					...
					public void setValues(PreparedStatement ps) throws SQLException {
						...
						ps.setString(4, GCCalculationConstant.SERVICE_FIELD_VALUE_WS);
