...
import org.egov.gccalculation.repository.builder.GCCalculatorQueryBuilder;
import org.egov.gccalculation.repository.rowmapper.BillSearchRowMapper;
import org.egov.gccalculation.repository.rowmapper.BillSearchRowMappers;
import org.egov.gccalculation.repository.rowmapper.DemandSchedulerRowMapper;
import org.egov.gccalculation.repository.rowmapper.Demandcancelwrapper;
import org.egov.gccalculation.repository.rowmapper.MeterReadingCurrentReadingRowMapper;
import org.egov.gccalculation.repository.rowmapper.MeterReadingRowMapper;
...
@Slf4j
@Repository
public class GCCalculationDaoImpl implements GCCalculationDao {

	@Autowired
	private GCCalculationProducer wSCalculationProducer;

	@Autowired
	private GCCalculatorQueryBuilder queryBuilder;
	...
	@Autowired
	private GarbageRowMapper waterRowMapper;

	@Autowired
	private GarbageConnectionRowMapper waterConnectionRowMapper;

	@Autowired
	private GarbageDemandRowMapper waterDemandRowMapper;
	...
	public List<String> getConnectionsNoByLocality(String tenantId, String connectionType, String locality) {
		List<Object> preparedStatement = new ArrayList<>();
		String query = queryBuilder.getConnectionsNoByLocality(tenantId, connectionType, GCCalculationConstant.ACTIVE_CONNECTION, locality,null, preparedStatement);
	...
	public List<String> getConnectionsNoByGroups(String tenantId, String connectionType, String group) {
		List<Object> preparedStatement = new ArrayList<>();
		String query = queryBuilder.getConnectionsNoByLocality(tenantId, connectionType, GCCalculationConstant.ACTIVE_CONNECTION, null,group, preparedStatement);
		log.info("preparedStatement: " + preparedStatement + " query : " + query);
		return jdbcTemplate.queryForList(query, preparedStatement.toArray(), String.class);
	}
	...
	public List<GarbageDetails> getConnectionsNoListforsingledemand(String tenantId, String connectionType, Long taxPeriodFrom,
			...
			String query = queryBuilder.getConnectionNumberList(tenantId, connectionType,
					GCCalculationConstant.ACTIVE_CONNECTION, taxPeriodFrom, taxPeriodTo, cone, preparedStatement);
