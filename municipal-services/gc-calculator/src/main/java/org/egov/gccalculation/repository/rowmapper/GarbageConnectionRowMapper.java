...
@Component
public class GarbageConnectionRowMapper implements ResultSetExtractor<List<GarbageConnection>> {
...
//				currentWaterConnection.setRoadType(rs.getString("roadtype"));
				...
				additionalDetails.put(GCCalculationConstant.ADHOC_PENALTY, rs.getBigDecimal("adhocpenalty"));
				additionalDetails.put(GCCalculationConstant.ADHOC_REBATE, rs.getBigDecimal("adhocrebate"));
				additionalDetails.put(GCCalculationConstant.ADHOC_PENALTY_REASON, rs.getString("adhocpenaltyreason"));
