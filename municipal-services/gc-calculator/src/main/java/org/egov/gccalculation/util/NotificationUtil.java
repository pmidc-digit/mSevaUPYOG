...
public class NotificationUtil {
	...
	public StringBuilder getUri(String tenantId, RequestInfo requestInfo) {
		...
		String locale = GCCalculationConstant.NOTIFICATION_LOCALE;
		...
		uri.append(config.getLocalizationHost()).append(config.getLocalizationContextPath())
				...
				.append("&tenantId=").append(tenantId).append("&module=").append(GCCalculationConstant.MODULE);
	...
	public String getCustomizedMsgForSMS(String topic, String localizationMessage) {
		...
		if (topic.equalsIgnoreCase(config.getOnDemandsSaved())) {
			messageString = getMessageTemplate(GCCalculationConstant.DEMAND_SUCCESS_MESSAGE_SMS, localizationMessage);
		}
		if (topic.equalsIgnoreCase(config.getOnDemandsFailure())) {
			messageString = getMessageTemplate(GCCalculationConstant.DEMAND_FAILURE_MESSAGE_SMS, localizationMessage);
		}
		if (topic.equalsIgnoreCase(config.getPayTriggers())) {
			messageString = getMessageTemplate(GCCalculationConstant.WATER_CONNECTION_BILL_GENERATION_SMS_MESSAGE,
					localizationMessage);
		}
	...
	public String getCustomizedMsgForInApp(String topic, String localizationMessage) {
		String messageString = null;
		if (topic.equalsIgnoreCase(config.getPayTriggers())) {
			messageString = getMessageTemplate(GCCalculationConstant.WATER_CONNECTION_BILL_GENERATION_APP_MESSAGE,
					localizationMessage);
		}
		return messageString;
	}
