package org.egov.garbagecollection.constants;
...
public class GCConstants {
	...
	public static final String INITIATE_INITIATED = "SUBMIT_APPLICATION_PENDING_FOR_PAYMENT";
	...
	public static final String PAY_PENDING_FOR_CONNECTION_ACTIVATION = "PAY_PENDING_FOR_CONNECTION_ACTIVATION"; // kept for other flows

	public static final String PAY_CONNECTION_ACTIVATED = "PAY_CONNECTION_ACTIVATED";
	...
	public static final String SUBMIT_APPLICATION_PENDING_FOR_DOCUMENT_VERIFICATION = "SUBMIT_APPLICATION_PENDING_FOR_DOCUMENT_VERIFICATION"; // kept for other flows

	public static final String SUBMIT_APPLICATION_PENDING_FOR_PAYMENT = "SUBMIT_APPLICATION_PENDING_FOR_PAYMENT";
	...
	public static final List<String> NOTIFICATION_ENABLE_FOR_STATUS = Collections
			.unmodifiableList(Arrays.asList(INITIATE_INITIATED, REJECT_REJECTED,
					...
					PAY_PENDING_FOR_CONNECTION_ACTIVATION, PAY_CONNECTION_ACTIVATED,
	...
	// PENDING_FOR_CONNECTION_ACTIVATION state removed from NewGC workflow; kept for reconnect/other flows
