...
import org.egov.garbagecollection.web.models.DocumentDetails;
...
public class DocumentRepository {
	...
	private void enrichDocumentsWithDetails(List<DocumentDetails> documents) {
		...
		List<Map<String, Object>> res = namedParameterJdbcTemplate.queryForList(WS_CONNECTION_UUID_QUERY, params);
