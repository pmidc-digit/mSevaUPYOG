...
public class UnmaskingUtil {
    ...
    public void getOwnerDetailsUnmasked(GarbageConnection garbageConnection, RequestInfo requestInfo) {
        ...
        UserSearchRequest userSearchRequest = userService.getBaseUserSearchRequest(garbageConnection.getTenantId(), requestInfo);

        Set<String> ownerIds = new HashSet<>();

        for (OwnerInfo ownerInfo : garbageConnection.getConnectionHolders()) {
