...
//	private Double proposedPipeSize = null;
	...
	private boolean isworkflowdisabled = false;
...
//		return Objects.equals(this.waterSource, garbageConnection.waterSource)
//				&& Objects.equals(this.meterId, garbageConnection.meterId)
//				&& Objects.equals(this.meterInstallationDate, garbageConnection.meterInstallationDate) && super.equals(o);
//	}
//
//	@Override
//	public int hashCode() {
