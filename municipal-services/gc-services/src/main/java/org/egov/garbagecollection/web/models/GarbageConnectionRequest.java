...
public class GarbageConnectionRequest {
	...
	public GarbageConnectionRequest waterConnection(GarbageConnection garbageConnection) {
		this.garbageConnection = garbageConnection;
		return this;
	}
	
	public GarbageConnectionRequest disconnectionRequest(boolean isDisconnectionRequest) {
		this.disconnectRequest = isDisconnectionRequest;
		return this;
	}
	
	public GarbageConnectionRequest reconnectionRequest(boolean isReconnectionRequest) {
	...
	public String toString() {
		...
		sb.append("    waterConnection: ").append(toIndentedString(garbageConnection)).append("\n");
		sb.append("}");
		return sb.toString();
	}
