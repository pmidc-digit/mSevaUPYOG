...
public class LayoutInboxFilterService {
    ...
    //This is made so as to perform ulb wise grouping
    public List<Map<String, String>> fetchTenantWiseApplicationNumbersFromSearcher(InboxSearchCriteria criteria,
        ...
        Object result = restTemplate.postForObject(endpoint, searcherRequest, Map.class);
        List<Map<String, String>> tenantWiseApplns = JsonPath.read(result, "$.layoutApplication.*");
    ...
    private Map<String, Object> getSearchCriteria(InboxSearchCriteria criteria,
        ...
        //add the owner uuid if its a citizen view otherwise if we get uuids like mobilenumber search from the module search criteria then we add it directly in my applications view we send the created by on the citizen side
