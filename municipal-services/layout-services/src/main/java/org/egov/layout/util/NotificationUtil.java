...
public class NotificationUtil {
	...
	/**
	 * Creates customized message based on layout
	 * 
	 * @param noc
	 *            The layout for which message is to be sent
	 * @param localizationMessage
	 *            The messages from localization
	 * @return customized message based on layout
	 */
	public String getCustomizedMsg(RequestInfo requestInfo, Layout noc, String localizationMessage) {
	 ...
	 * 
	 * @param noc
	 *            tenantId of the layout
	 * @param message
	 *            Message from localization for initiate
	 * @return customized message for initiate
	 */
	private String getInitiatedMsg(Layout noc, String message) {
		String type = null;
		if(noc.getLayoutType().equalsIgnoreCase(LAYOUTConstants.FIRE_NOC_TYPE)){
			type = "Fire";
		}else{
			type = "AAI";
		}
