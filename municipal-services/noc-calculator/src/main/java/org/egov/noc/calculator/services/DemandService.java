...
import static org.egov.noc.calculator.utils.NOCConstants.EMPTY_DEMAND_ERROR_CODE;
import static org.egov.noc.calculator.utils.NOCConstants.EMPTY_DEMAND_ERROR_MESSAGE;
...
public class DemandService {
    ...
    public List<Demand> generateDemands(RequestInfo requestInfo, List<Calculation> calculations) {
        ...
        StringBuilder url = new StringBuilder().append(nocConfiguration.getBillingHost())
