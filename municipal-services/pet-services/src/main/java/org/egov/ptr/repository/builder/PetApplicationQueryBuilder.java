...
public class PetApplicationQueryBuilder {
	...
	private static final String BASE_PTR_QUERY = " SELECT ptr.id as pid, ptr.tenantid as ptenantid, ptr.applicationNumber as papplicationnumber, "
			...
			+ "ptr.status as pstatus, ptr.expireFlag as pexpireflag, ptr.petToken as ppettoken, ptr.previousApplicationNumber as ppreviousapplicationnumber, ptr.petregistrationnumber as ppetregistrationnumber, ptr.propertyId as ppropertyId, ptr.consentDocument as pconsentdocument, "
