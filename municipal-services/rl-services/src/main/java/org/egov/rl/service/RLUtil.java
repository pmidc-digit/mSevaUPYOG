...
//@Component
//@Slf4j
//public class RLUtil extends CommonUtils {
//
//	@Autowired
...
//		if (mdmsResponse.getMdmsRes().get(RLConstants.RL_MASTER_MODULE_NAME) == null) {
//			throw new CustomException("FEE_NOT_AVAILABLE", "Pet registration fee not available.");
//		}
//		JSONArray jsonArray = mdmsResponse.getMdmsRes().get(RLConstants.RL_MASTER_MODULE_NAME).get("BreedType");
//
//		try {
