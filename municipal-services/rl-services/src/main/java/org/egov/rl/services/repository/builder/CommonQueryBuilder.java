...
public class CommonQueryBuilder {
	...
	private static final String BASE_QUERY = ""
	        ...
	        + " rev.id as rev_id, rev.allotment_id as rev_allotmentId, rev.revised_rent, rev.revision_date, rev.next_revision_date, rev.increment_percentage, rev.tenant_id as rev_tenantId, rev.active as rev_active, rev.created_time as rev_createdTime, rev.created_by as rev_createdBy, rev.lastmodified_time as rev_lastmodifiedTime, rev.lastmodified_by as rev_lastmodifiedBy"
			...
			+ " LEFT JOIN eg_rl_rent_revision AS rev ON al.id = rev.allotment_id "
