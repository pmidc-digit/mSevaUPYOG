...
//		List<SewerageDetails> sewerageDetailsTwo =  null;
		if((tenantId.equals("pb.amritsar"))) {
            if(locality!=null && !locality.trim().isEmpty()) {
                ...
                query = queryBuilder.getConnectionNumberListForNonCommercial(tenantId, null, connectionType, SWCalculationConstant.ACTIVE, fromDate, toDate, Connectionno, preparedStatement);
            }
...
//			 sewerageDetails.addAll(sewerageDetailsTwo);
            ...
            if(locality!=null && !locality.trim().isEmpty()) {
                ...
                query = queryBuilder.getConnectionNumberListsingle(tenantId, null, connectionType, preparedStatement, fromDate, toDate, Connectionno);
...
/* CancelBill */
	...
	public Boolean isBatchDemandExecuted(String tenantId, String locality, Long taxPeriodFrom, Long taxPeriodTo) {
		try {
            ...
            return jdbcTemplate.queryForObject(query_tenant, new Object[]{tenantId, taxPeriodFrom, taxPeriodTo}, Boolean.class);
		} catch (Exception e) {
