...
public class TLConstants {
    ...
    public static final String NOTIF_TRADE_APPROVED_EMAIL = "notification.tl.activation.email";
    ...
    public static final List<String> NOTIFICATION_CODES = Collections.unmodifiableList(Arrays.asList(
            ...
            NOTIFICATION_EXPIRED,NOTIFICATION_EXPIRED_EMAIL,NOTIFICATION_MANUAL_EXPIRED,NOTIFICATION_MANUAL_EXPIRED_EMAIL,NOTIFICATION_PROPERTY_TAGGED,NOTIFICATION_PROPERTY_TAGGED_EMAIL,NOTIFICATION_PROPERTY_CREATED,NOTIFICATION_PROPERTY_CREATED_EMAIL, NOTIF_TRADE_APPROVED_EMAIL));
