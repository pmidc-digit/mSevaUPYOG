...
//	}
	...
	public String generateDemandForSingle(Map<String, Object> master, SingleDemand singleDemand, String tenantId,
		...
		try {
			...
			List<WaterDetails> connectionNos = waterCalculatorDao.getConnectionsNoListforsingledemand(tenantId,null, WSCalculationConstant.nonMeterdConnection, taxPeriodFrom, taxPeriodTo, cone);
