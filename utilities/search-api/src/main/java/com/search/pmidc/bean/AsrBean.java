...
@Entity
@Table(name = "amritsar_pt_legacy_data")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
public class AsrBean implements Serializable {
	...
	public String toString() {
		return "AsrBean [srno=" + srno + ", returnid=" + returnid + ", acknowledgementno=" + acknowledgementno
