...
@Entity
@Table(name = "bathinda_pt_legacy_data")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
public class BathindaBean implements Serializable{
	...
	@Column(name = "unbuiltarea")
	private String unbuiltarea;
	...
	@Column(name = "waterconnectionno")
	private String waterconnectionno;
	
	@Column(name = "electrictyconnectionno")
	private String electrictyconnectionno;
	...
	@Column(name = "height_above_36ft")
	private String height_above_36ft;
	...
	@Column(name = "upload_response_workflow")
	private String upload_response_workflow;
	
	@Column(name = "upload_response_assessment")
	private String upload_response_assessment;
	...
	public String getUnbuiltarea() {
		return unbuiltarea;
	}

	public void setUnbuiltarea(String unbuiltarea) {
		this.unbuiltarea = unbuiltarea;
	}
	...
	public String getElectrictyconnectionno() {
		return electrictyconnectionno;
	}

	public void setElectrictyconnectionno(String electrictyconnectionno) {
		this.electrictyconnectionno = electrictyconnectionno;
	}
	...
	public void setClient_data_id(String client_data_id) {
		this.client_data_id = client_data_id;
	}

	public String getHeight_above_36ft() {
		return height_above_36ft;
	}

	public void setHeight_above_36ft(String height_above_36ft) {
		this.height_above_36ft = height_above_36ft;
	}
	...
	public String getUpload_response_workflow() {
		return upload_response_workflow;
	}

	public void setUpload_response_workflow(String upload_response_workflow) {
		this.upload_response_workflow = upload_response_workflow;
	}

	public String getUpload_response_assessment() {
		return upload_response_assessment;
	}

	public void setUpload_response_assessment(String upload_response_assessment) {
		this.upload_response_assessment = upload_response_assessment;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((client_data_id == null) ? 0 : client_data_id.hashCode());
		...
		result = prime * result + ((electrictyconnectionno == null) ? 0 : electrictyconnectionno.hashCode());
		...
		result = prime * result + ((height_above_36ft == null) ? 0 : height_above_36ft.hashCode());
		...
		result = prime * result + ((leasedetail == null) ? 0 : leasedetail.hashCode());
		...
		result = prime * result + ((unbuiltarea == null) ? 0 : unbuiltarea.hashCode());
		result = prime * result + ((upload_response == null) ? 0 : upload_response.hashCode());
		result = prime * result + ((upload_response_assessment == null) ? 0 : upload_response_assessment.hashCode());
		result = prime * result + ((upload_response_workflow == null) ? 0 : upload_response_workflow.hashCode());
		result = prime * result + ((upload_status == null) ? 0 : upload_status.hashCode());
		result = prime * result + ((usage == null) ? 0 : usage.hashCode());
		result = prime * result + ((uuid == null) ? 0 : uuid.hashCode());
		result = prime * result + ((waterconnectionno == null) ? 0 : waterconnectionno.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BathindaBean other = (BathindaBean) obj;
		...
		if (businessname == null) {
			...
			return false;
		if (client_data_id == null) {
			if (other.client_data_id != null)
				return false;
		} else if (!client_data_id.equals(other.client_data_id))
			return false;
		if (colony == null) {
		...
		if (commercialrate == null) {
			...
			return false;
		if (electrictyconnectionno == null) {
			if (other.electrictyconnectionno != null)
				return false;
		} else if (!electrictyconnectionno.equals(other.electrictyconnectionno))
			return false;
		if (entrydate == null) {
		...
		if (grosstax == null) {
			...
			return false;
		if (height_above_36ft == null) {
			if (other.height_above_36ft != null)
				return false;
		} else if (!height_above_36ft.equals(other.height_above_36ft))
			return false;
		if (houseno == null) {
		...
		if (landusedtype == null) {
			...
			return false;
		if (leasedetail == null) {
			if (other.leasedetail != null)
				return false;
		} else if (!leasedetail.equals(other.leasedetail))
			return false;
		...
		if (transactionid == null) {
			...
			return false;
		if (unbuiltarea == null) {
			if (other.unbuiltarea != null)
				return false;
		} else if (!unbuiltarea.equals(other.unbuiltarea))
			return false;
		if (upload_response == null) {
			...
			return false;
		if (upload_response_assessment == null) {
			if (other.upload_response_assessment != null)
				return false;
		} else if (!upload_response_assessment.equals(other.upload_response_assessment))
			return false;
		if (upload_response_workflow == null) {
			if (other.upload_response_workflow != null)
				return false;
		} else if (!upload_response_workflow.equals(other.upload_response_workflow))
			return false;
		...
		if (waterconnectionno == null) {
			if (other.waterconnectionno != null)
				return false;
		} else if (!waterconnectionno.equals(other.waterconnectionno))
			return false;
		if (zone == null) {
			if (other.zone != null)
				return false;
	...
	public String toString() {
		return "BathindaBean [srno=" + srno + ", returnid=" + returnid + ", acknowledgementno=" + acknowledgementno
				+ ", entrydate=" + entrydate + ", zone=" + zone + ", sector=" + sector + ", colony=" + colony
				+ ", houseno=" + houseno + ", owner=" + owner + ", leasedetail=" + leasedetail + ", address=" + address
				+ ", floor=" + floor + ", unbuiltarea=" + unbuiltarea + ", residentialrate=" + residentialrate
				+ ", commercialrate=" + commercialrate + ", exemptioncategory=" + exemptioncategory + ", landusedtype="
				+ landusedtype + ", usage=" + usage + ", plotarea=" + plotarea + ", totalcoveredarea="
				+ totalcoveredarea + ", grosstax=" + grosstax + ", firecharges=" + firecharges + ", interestamt="
				+ interestamt + ", penalty=" + penalty + ", rebate=" + rebate + ", exemptionamt=" + exemptionamt
				+ ", taxamt=" + taxamt + ", amountpaid=" + amountpaid + ", paymentmode=" + paymentmode
				...
				+ ", buildingcategory=" + buildingcategory + ", session=" + session + ", remarks=" + remarks
				+ ", businessname=" + businessname + ", waterconnectionno=" + waterconnectionno
				+ ", electrictyconnectionno=" + electrictyconnectionno + ", photoid=" + photoid + ", client_data_id="
				+ client_data_id + ", height_above_36ft=" + height_above_36ft + ", uuid=" + uuid
				+ ", previous_returnid=" + previous_returnid + ", status=" + status + ", tenantid=" + tenantid
				...
				+ parent_uuid + ", colony_processed=" + colony_processed + ", upload_response_workflow="
				+ upload_response_workflow + ", upload_response_assessment=" + upload_response_assessment
				+ ", owner_brushed=" + owner_brushed + ", owner_multi_temp=" + owner_multi_temp + "]";
	}
