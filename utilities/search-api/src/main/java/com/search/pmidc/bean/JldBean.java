...
@Entity
@Table(name = "jalandhar_pt_legacy_data")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
public class JldBean implements Serializable {
	...
	public String toString() {
		return "JldBean [srno=" + srno + ", returnid=" + returnid + ", acknowledgementno=" + acknowledgementno
				+ ", entrydate=" + entrydate + ", zone=" + zone + ", sector=" + sector + ", colony=" + colony
				+ ", houseno=" + houseno + ", owner=" + owner + ", floor=" + floor + ", exemptioncategory="
				+ exemptioncategory + ", landusedtype=" + landusedtype + ", usage=" + usage + ", plotarea=" + plotarea
				...
				+ parent_uuid + ", colony_processed=" + colony_processed + "]";
	}
