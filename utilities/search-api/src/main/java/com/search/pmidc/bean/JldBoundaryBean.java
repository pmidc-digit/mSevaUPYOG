...
@Entity
@Table(name = " jalandhar_boundary")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
public class JldBoundaryBean implements Serializable {
	...
	public String toString() {
		return "JldBoundaryBean [code=" + code + ", colony=" + colony + ", sector=" + sector + ", area=" + area
