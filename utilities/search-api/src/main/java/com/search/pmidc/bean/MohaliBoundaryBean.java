...
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
	...
	@Entity
	@Table(name = "mohali_boundary")
	@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
	public class MohaliBoundaryBean implements Serializable {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			MohaliBoundaryBean other = (MohaliBoundaryBean) obj;
			if (area == null) {
				if (other.area != null)
					return false;
		...
		public String toString() {
			return "MohaliBoundaryBean [code=" + code + ", colony=" + colony + ", sector=" + sector + ", area=" + area
