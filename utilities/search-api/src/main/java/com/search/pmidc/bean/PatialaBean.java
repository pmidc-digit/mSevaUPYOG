...
@Entity
@Table(name = "patiala_pt_legacy_data")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
public class PatialaBean implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PatialaBean other = (PatialaBean) obj;
	...
	public String toString() {
		return "PatialaBean [srno=" + srno + ", returnid=" + returnid + ", acknowledgementno=" + acknowledgementno
