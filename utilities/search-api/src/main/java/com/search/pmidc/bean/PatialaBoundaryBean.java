...
@Entity
@Table(name = "patiala_boundary")
@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
public class PatialaBoundaryBean implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PatialaBoundaryBean other = (PatialaBoundaryBean) obj;
		if (area == null) {
			if (other.area != null)
				return false;
	...
	public String toString() {
		return "PatialaBoundaryBean [code=" + code + ", colony=" + colony + ", sector=" + sector + ", area=" + area
